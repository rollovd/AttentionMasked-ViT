...
class MobileNetV2(nn.Module):
    def __init__(self,
                 alpha=0.25, sigma=256, avg_pool_2d=True, inverted_residual_setting=None,
                 round_nearest=8,
                 block=None,
                 norm_layer=None):
        """
        ...
        Args:
            alpha (float): Width multiplier - adjusts number of channels in each layer by this amount
        ...
        # building classifier
        self.output_layer = AgnosticClassifierHead(sigma=sigma)
...
def mobilenetv2(pretrained=False, dropout=0, fp16=0):
    return MobileNetV2()